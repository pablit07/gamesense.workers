...
var Worker = require('../workers/drill_streak');
	...
	db = {
		collection: () => {
			return {
                ...
                updateOne: () => {},
				count: () => { return 1; },
				findOne: (q) => { return  q.startDate == 'January 10th 2019' && q.endDate ==  'January 11th 2019' ? {"timestamp":"2019-01-12T03:49:00.000Z","startDate":"January 10th 2019","endDate":"January 11th 2019","startDate_raw":"2019-01-10T06:00:00.000Z","endDate_raw":"2019-01-11T06:00:00.000Z","processed_worker":"2019-10-24T03:01:52-06:00","id_submission":"e494872f56b1ab9ceff6837eada9dd84","user_id":1159,"app":"SB","team_id":"","days":1,"responses":1} : false },
				findOneAndUpdate: () => {},
				find: () => {
					return {
						project: () => {
