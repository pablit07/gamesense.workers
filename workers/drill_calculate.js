...
var MongoRmqRepublishWorker = require("../lib/MongoRmqRepublishWorker");
...
class Task extends MongoRmqRepublishWorker {
  ...
  */
  async myTask(msgContent, msg, conn, ch, db) {
                  try {
                      ...
                      data.pitcher_hand = rows[0].pitcher_hand;
                      data.pitch_count = rows[0].pitch_count;
                      data.pitcher_code = rows[0].pitcher_code;
                      data.pitch_number = rows[0].pitch_number;
